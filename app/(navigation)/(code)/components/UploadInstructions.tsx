  ...
  return (
    <div className={styles.root}>
      ...
      <p className={styles.description}>
        Click the upload button above to add your files. They will be securely stored in your browser&apos;s local
        storage. To remove files, simply click the button again.
        <br />
        <br />
        When uploading a{" "}
        <strong>
          <a href="https://stackoverflow.com/a/15438863" target="_blank" rel="noopener noreferrer">
            git patch
          </a>
        </strong>{" "}
        file, each modified file within the patch will be treated as a separate file with optional highlighting for
        diffs.
      </p>
    </div>
  );
