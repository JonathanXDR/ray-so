      ...
      <DialogContent size="large">
        <div className="flex gap-8">
          <div className="flex flex-col gap-3 flex-1 text-[13px] text-gray-11 leading-relaxed">
            ...
            <p>
              Preset Explorer is a tool to easily browse, share, and add presets to{" "}
              <a href="https://raycast.com">Raycast</a>.
            </p>
            <p>
              Open a preset and click the “Add to Raycast” button to import the preset directly into Raycast. You can
              also download the preset as a JSON file, or copy the URL to share with others.
            </p>
            ...
            <p>
              ...
              or{" "}
              <a
                href="mailto:feedback+rayso@raycast.com?subject=Presets"
