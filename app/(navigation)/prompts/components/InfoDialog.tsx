      ...
      <DialogContent size="large">
        <div className="flex gap-8">
          <div className="flex flex-col gap-3 flex-1 text-[13px] text-gray-11 leading-relaxed">
            ...
            <p>
              Select the prompts by clicking on them. To select multiple, hold <Kbd>⌘</Kbd> or select them with your
              mouse.
            </p>
            <p>
              Then, click the “Add to Raycast” button to import these prompts as AI Commands. You can also download the
              prompts as a JSON file, or copy the URL to share with others.
            </p>
