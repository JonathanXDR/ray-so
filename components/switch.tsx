...
const Switch = React.forwardRef<React.ComponentRef<typeof SwitchPrimitives.Root>, SwitchProps>(
  ({ className, color, ...props }, ref) => (
    <SwitchPrimitives.Root
      className={cn(
        "inline-flex h-4 w-7 px-[3px] shrink-0 cursor-default items-center rounded-full transition-colors focus-visible:outline-hidden focus-visible:ring-2 focus-visible:ring-gray-7 focus-visible:ring-offset-2 focus-visible:ring-offset-gray-2 disabled:cursor-not-allowed disabled:opacity-50 data-[state=checked]:bg-[#56c2ff] data-[state=unchecked]:bg-gray-7 duration-250",
